...
@dataclass
class Exp_Moxin_7B_224px_Bridge(Exp_DinoSigLIP_224px_Bridge):
    vla_id: str = "moxin-7b-224px+mx-bridge"
    base_vlm: Union[str, Path] = "prism-moxin-dinosiglip-224px+7b+stage-finetune+x7"

    data_mix: str = "bridge"
    action_tokenizer: str = "action_tokenizer"

    max_steps: Optional[int] = 120000
    
    # Modified for 2 GPUs
    expected_world_size: int = 4
    global_batch_size: int = 128  # Reduced from 256 to 64
    per_device_batch_size: int = 32
...
class VLARegistry(Enum):
    ...
    # === Moxin Fine-tuning Configs ===
    MOXIN_7B_224PX_MX_BRIDGE = Exp_Moxin_7B_224px_Bridge
